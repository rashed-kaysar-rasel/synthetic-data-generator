...
**Branch**: `001-auth-module` | **Date**: 2026-02-11 | **Spec**: `C:\Projects\synthetic-data-generator\specs\001-auth-module\spec.md`
**Input**: Feature specification from `C:\Projects\synthetic-data-generator\specs\001-auth-module\spec.md`

## Summary

Add user authentication (register, login, logout, password reset) while preserving guest access to data generation routes and UI.
...
- **Schema-First Workflow**: Pass. Authentication does not alter schema ingestion requirements.
- **Relational Integrity**: Pass. No changes to FK ordering or sampling logic.
- **Synthetic Data Safety**: Pass. No use of real data; auth uses user-supplied credentials only.
...
```text
C:\Projects\synthetic-data-generator\specs\001-auth-module\
+-- plan.md
+-- research.md
+-- data-model.md
+-- quickstart.md
